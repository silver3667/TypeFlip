...
def register_hotkeys(
    ...
    keyboard.add_hotkey('shift+f4', on_summarize, suppress=False)
    keyboard.add_hotkey('shift+f5', on_prompt_optimize, suppress=False)
    keyboard.add_hotkey('shift+f6', on_expand_prompt, suppress=False)
    keyboard.add_hotkey('shift+f7', on_humanize, suppress=False)
